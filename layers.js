...
var lyr_lab1lab_1_2 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/lab1lab_1_2.png" /> lab1 — lab_1'
            });
...
lyr_YandexSatellite_0.setVisible(true);lyr_OSMStandard_1.setVisible(true);lyr_lab1lab_1_2.setVisible(true);lyr_building_house_3.setVisible(true);lyr_highway_4.setVisible(true);lyr_highway_5.setVisible(true);
var layersList = [lyr_YandexSatellite_0,lyr_OSMStandard_1,lyr_lab1lab_1_2,lyr_building_house_3,lyr_highway_4,lyr_highway_5];
...
lyr_highway_4.set('fieldAliases', {'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'highway': 'highway', 'public_transport': 'public_transport', 'name': 'name', 'bus': 'bus', 'crossing': 'crossing', });
lyr_highway_5.set('fieldAliases', {'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'highway': 'highway', 'footway': 'footway', 'ford': 'ford', 'depth': 'depth', 'ref': 'ref', 'old_ref': 'old_ref', 'oneway': 'oneway', 'surface': 'surface', 'smoothness': 'smoothness', 'layer': 'layer', 'foot': 'foot', 'bridge': 'bridge', 'bicycle': 'bicycle', 'access': 'access', 'name': 'name', });
lyr_lab1lab_1_2.set('fieldImages', {'fid': 'TextEdit', 'name': 'TextEdit', });
lyr_building_house_3.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'building': '', 'addr:street': '', 'addr:postcode': '', 'addr:housenumber': '', 'addr:city': '', 'address': '', });
lyr_highway_4.set('fieldImages', {'full_id': '', 'osm_id': '', 'osm_type': '', 'highway': '', 'public_transport': '', 'name': '', 'bus': '', 'crossing': '', });
lyr_highway_5.set('fieldImages', {'full_id': '', 'osm_id': '', 'osm_type': '', 'highway': '', 'footway': '', 'ford': '', 'depth': '', 'ref': '', 'old_ref': '', 'oneway': '', 'surface': '', 'smoothness': '', 'layer': '', 'foot': '', 'bridge': '', 'bicycle': '', 'access': '', 'name': '', });
...
lyr_highway_4.set('fieldLabels', {'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'public_transport': 'no label', 'name': 'no label', 'bus': 'no label', 'crossing': 'no label', });
lyr_highway_5.set('fieldLabels', {'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'footway': 'no label', 'ford': 'no label', 'depth': 'no label', 'ref': 'no label', 'old_ref': 'no label', 'oneway': 'no label', 'surface': 'no label', 'smoothness': 'no label', 'layer': 'no label', 'foot': 'no label', 'bridge': 'no label', 'bicycle': 'no label', 'access': 'no label', 'name': 'no label', });
